...
class ConceptNetAdapter:
    """
    [ru] Адаптер для преобразования ConceptNet в ваш ГЗ.
    [en] Adapter for converting ConceptNet into your Knowledge Base.
    """
    ...
    def convert_node(self, conceptnet_node):
        """
        [ru] Преобразует узел ConceptNet в ваш KnowledgeNode.
        [en] Converts a ConceptNet node into your KnowledgeNode.
        """
        node = KnowledgeNode(
    ...
    def convert_edge(self, conceptnet_edge):
        """
        [ru] Преобразует ребро ConceptNet в ваше KnowledgeEdge.
        [en] Converts a ConceptNet edge into your KnowledgeEdge.
        """
        edge = KnowledgeEdge(
