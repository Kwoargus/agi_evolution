# core/objects.py (добавляем методы для работы с сеткой)
...
class GameObject:
    def __init__(self, x, z, obj_type="fire", temperature=800, size=1.0):
        ...
        self.size = size
        self.active = True  # Добавляем флаг активности
...
class Explosion:
    ...
    def update(self, dt):
        ...
        self.rotation = 120 * (self.age // 1.0)
    ...
    def draw(self, screen, world_to_screen_func):
        ...
        top_world = (self.x, self.z, -self.size * 0.8 * self.scale)
