...
class Explosion:
    ...
    def update(self, dt=1.0):
        ...
        # [ru] Быстрое расширение (50% времени) и быстрое затухание
        # [en] Fast expansion (50% of time) and fast fade
        if progress < 0.5:
    ...
    def draw(self, screen, world_to_screen_func):
        ...
        # [ru] Внешние кольца - яркие и быстрые
        # [en] Outer rings - bright and fast
        for i in range(3):
            r = radius_px - i * 6
            if r > 0:
